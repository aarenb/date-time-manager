...
## Allmän reflektion
Att skriva kod som jag vet att någon annan kommer använda sig av gör att jag aktivt måste tänka mycket mer på namngivning och tydlighet i koden. Det är inte något som jag har någon erfarenhet av sedan tidigare, då de enda som har kollat på min kod är jag och examinatorn i kursen. Att faktiskt skapa ett bibliotek, och sedan ladda upp det på npm, har varit både roligt och lärorikt. Vissa saker såsom att skriva “dry” kod är något som jag redan tagit till mig från tidigare kurser och nu konstant tänker på när jag skriver kod, det bara känns naturligt nu. Jag tror att efter ett litet tag kommer de flesta kodkvalitet reglerna som vi nu lär oss om också vara sådant som jag “automatiskt” tänker på. Dock så kan vissa saker som tas upp i Clean Code ibland kännas onödigt eller lite extremt, som att funktioner ”oftast inte ens borde vara 20 linjer långa”. En funktion som är så lång att man måste skrolla ner är definitivt svår att förstå, men ibland känns det definitivt ok att ha funktioner som inte är pyttesmå. 
